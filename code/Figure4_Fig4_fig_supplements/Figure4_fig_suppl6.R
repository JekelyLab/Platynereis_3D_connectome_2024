# code to generate Figure 4 fig suppl  of the Platynereis connectome paper
# Gaspar Jekely 2024
...
webshot::webshot(
  ...
  file = "Figures/Figure4_fig_suppl6.png",
  vwidth = 6000, vheight = 3000, # define the size of the browser window
  cliprect = c(100, 280, 5500, 2750), zoom = 1, delay = 1
)

write_rds(
  syn.vis, "source_data/Figure4_fig_suppl6_source_data1.bz2", 
  compress = "bz2"
  )
syn.vis <- read_rds("source_data/Figure4_fig_suppl6_source_data1.bz2")
